...
@WebServlet("jhomehome/hh01Ok")
public class hh01Ok extends HttpServlet{
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!mid.equals("admin") || !pwd.equals("1234")) {
			...
			response.sendRedirect(request.getContextPath()+"/study/jhomehome/hh01.jsp?msgFlag=no");
			return;
		}
		// 정상회원들 처리부분...
